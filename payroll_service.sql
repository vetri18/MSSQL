...
/* UC3 */
Insert into employee_payroll values('kala',70000,GETDATE());
Insert into employee_payroll values('Gagan',80000,GETDATE());
Insert into employee_payroll values('Vishnu',60000,GETDATE());
Insert into employee_payroll values('Vaishak',180000,GETDATE());
Insert into employee_payroll values('Vinoth',100000,'2018-01-01');

/* UC4 */
Select * from employee_payroll;

/* UC5 */
SELECT salary FROM employee_payroll WHERE name = 'Vinoth';
...
UPDATE employee_payroll SET Gender = 'F' where name = 'kala';
UPDATE employee_payroll SET Gender = 'M' where name = 'Gagan';
UPDATE employee_payroll SET Gender = 'M' where name = 'Vishnu';
UPDATE employee_payroll SET Gender = 'M' where name = 'Vaishak';
UPDATE employee_payroll SET Gender = 'M' where name = 'Vinoth';
Select * from employee_payroll;
